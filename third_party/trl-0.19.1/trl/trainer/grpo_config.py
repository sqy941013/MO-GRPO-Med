...
class GRPOConfig(TrainingArguments):
    ...
    use_expectile_baseline: bool = field(
        default=False,
        metadata={"help": "Whether to use expectile baseline for advantage calculation."},
    )
    expectile_tau: float = field(
        default=0.7,
        metadata={"help": "Tau parameter for expectile baseline calculation."},
    )
    use_advantage_delta: bool = field(
        default=False,
        metadata={"help": "Whether to apply Huberized advantage clipping. Default is False for safety."},
    )
    advantage_delta: Optional[float] = field(
        default=0.65,
        metadata={"help": "Huberized advantage clipping threshold. Default is 0.65."},
    )
